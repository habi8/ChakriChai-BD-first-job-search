...
// All 64 districts of Bangladesh, plus Remote. (Bdjobs' search API ignores its
// location parameter, so district filtering happens in our ranker.)
...
export const LOCATION_GROUPS = [
  ...
  { label: 'Districts', options: BD_DISTRICTS },
];
